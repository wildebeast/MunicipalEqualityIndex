# Muncipal Equality Index (2024)

This directory contains the data from the Municipal Equality Index for 2024.
The Municipal Equality Index (MEI) is an annual report published by the Human Rights Campaign (HRC) that rates cities on their LGBTQ+ inclusivity. The MEI 2024 rates 506 cities in the United States.

The CSV file `mei-data-2024.csv` contains the following columns:
...
The CSV file `mei-totals-by-municipality-2024.csv` contains the point totals 
...
The file `template.csv` is used to generate `mei-data-2024.csv`.

The file `cities.csv` lists the 506 cities in the MEI 2024. It is generated by the Python script.

The file `mei_scrape.py` is a Python script that scrapes the MEI 2024 data from the HRC website. It generates the `mei-data-2024.csv` and `mei-totals-by-municipality-2024.csv` files.
...
* `cities.csv`: A list of the 506 cities in the MEI 2024.
* `mei-data-2024.csv`: The data from the MEI 2024.
* `mei-totals-by-municipality-2024.csv`: The point totals for each city.
